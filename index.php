...
<div class="container ctn">
    ...
    <div class="col-xs-12">
        ...
        if (isset($_GET['commande']) && $_GET['commande'] == 'success') {
            echo alerte(3, 'Votre commande a bien été passée, elle sera prête dans 15 min <span class="glyphicon glyphicon-time" aria-hidden="true"></span> !');
        }
        ?>
    </div>
    <section class="container-fluid text-center">
        <button class="btnsmblock btn btn-primary " type="button" data-toggle="collapse" data-target="#collapseSurMesure"
                aria-expanded="false" aria-controls="collapseSurMesure">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-9 carte">
                            <p>Chicken Rolls
                                <small>(poulet teriyaki, avocat, concombre)</small>
                            </p>
                        </div>
                        <div class="col-xs-3 prix"><p>4,50€</p></div>
                        <div class="col-xs-9 carte">
                            <p>Thon thon Rolls
                                <small>(thonade, avocat, concombre)</small>
                            </p>
                        </div>
                        <div class="col-xs-3 prix"><p>5,00€</p></div>
                        <div class="col-xs-9 carte">
                            <p>Rock'n'rolls
                                <small>(saumon, avocat, concombre)</small>
                            </p>
                        </div>
                        <div class="col-xs-3 prix"><p>6,60€</p></div>
                        <div class="col-xs-9 carte">
                            <p>Kimbap
                                <small>(thonade, carotte, concombre, oeuf, radis)</small>
                            </p>
                        </div>
                        <div class="col-xs-3 prix"><p>2,50€</p></div>
                        <div class="col-xs-9 carte">
                            <p>Mandu
                                <small>(ravioli coréen)</small>
                                X6
                            </p>
                        </div>
    ...
    <section>
        <div>
            <iframe width="100%" height="300px" frameBorder="0"
                    src="http://umap.openstreetmap.fr/fr/map/carte-sans-nom_130257?scaleControl=false&miniMap=false&scrollWheelZoom=false&zoomControl=true&allowEdit=false&moreControl=true&searchControl=null&tilelayersControl=null&embedControl=null&datalayersControl=true&onLoadPanel=undefined&captionBar=false"></iframe>
            <p><a href="http://umap.openstreetmap.fr/fr/map/carte-sans-nom_130257">Voir en plein écran</a></p>
        </div>
    </section>
    ...
    <footer>
        <div class="row">
            ...
            <div class="text-center col-xs-12 cgu">
                ...
                <a class="boutons-bas-footer" href="#" data-toggle="modal" data-target="#modalPaiements">Modes de
                    paiement |</a>
